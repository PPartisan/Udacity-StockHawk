...
import static com.sam_chordas.android.stockhawk.service.StockIntentService.*;
...
public class StockTaskService extends GcmTaskService{
    ...
    private static final String SELECT = "select * from yahoo.finance.quotes where symbol in (";

    private static final String DEFAULT_QUOTES =  "\"YHOO\",\"AAPL\",\"GOOG\",\"MSFT\")";
    ...
    public int onRunTask(TaskParams params){
        ...
        try{
            ...
            urlStringBuilder.append(URLEncoder.encode(SELECT, "UTF-8"));
        ...
        try{
            ...
            try {
                ...
                ArrayList<ContentProviderOperation> ops =
                        Utils.quoteJsonToContentProviderOperations(getResponse);

                if(ops == null) {
                    showToast(R.string.gcms_unrecognised_stock_symbol);
